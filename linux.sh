...
#Creating server
#curl -L -o $HOME/Figlet-fonts-1000plus.tar.xz https://github.com/efxtv/figlet-fonts/blob/main/Figlet-fonts-1000plus.tar.xz?raw=true -s;sudo tar xvf Figlet-fonts-1000plus.tar.xz -C /usr/share/figlet > /dev/null 2>&1
...
installedornot()
{
if [[ -e /usr/share/figlet/EFXfiglet997.flf ]]
then
...
sleep 1
curl -L -o $HOME/Figlet-fonts-1000plus.tar.xz https://github.com/efxtv/figlet-fonts/blob/main/Figlet-fonts-1000plus.tar.xz?raw=true -s;sudo tar xvf Figlet-fonts-1000plus.tar.xz -C /usr/share/figlet
...
ls -1 /usr/share/figlet|grep flf|grep -v EFXfiglet1073|grep -v EFXfiglet1159|awk '{print "figlet -f "$1" sangananio; echo [[--"$1"--]]"}' >saved
